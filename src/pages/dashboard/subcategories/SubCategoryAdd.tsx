  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Add New SubCategory</h1>
          <p className="text-muted-foreground mt-1">Fill in the details to add a new subcategory</p>
        </div>
      </div>
